...
14. Случайный лес.
16. Нейросеть (многослойный персептрон). Бинарная и многоклассовая классификация. Регрессия. Функции активации. Функции потерь. Обучение. Метод обратного распространения ошибки. Контроль переобучения.
17. Обучение без учителя. Кластеризация. Классификация алгоритмов. Показатели качества кластеризации. Метод kMeans.
18. Снижение размерности. PCA. UMAP.
19. Обработка текста. Способы кодирования. Мешок слов. TF-IDF. Классификация.
20. DataFrame. Nampy Array. Torch Tensor. Конвейеры sklearn. Утилиты Linux для работы для работы с файлами, простейшей обработки и анализа файлов. Google Colaboratory.
