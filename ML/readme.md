...
#### 3. Линейная регрессия. Метод наименьших квадратов. Статистический вывод
   ...
   - Теория + пример: [Линейная регрессия. МНК. Метод макс.правдоподобия. sklearn.ipynb colab.research.google.com/drive/1YadlNYk9_WkCQY6L-HKP9SI7xZjuzIMx](https://colab.research.google.com/drive/1YadlNYk9_WkCQY6L-HKP9SI7xZjuzIMx?usp=sharing)
...
# Вопросы
1. Задачи МО: классификацция и регрессия
2. Данные: признаки независые и целевые; показать в кое, обучающая и тестовая выборка.
3. Модели: персептрон, логистическая регрессия; показать в коде; обучение, предсказание
4. Метрики качества для регрессии и классфикаиции;
