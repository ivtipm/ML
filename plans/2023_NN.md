...
# Занятие 3. Повторение. Модицикации градиентного спуска.
сентябрь 13
1. Повторение. Регрессия. Регуляризация. Логистическая регрессия. Обучение и переобучение. Линейная разделимость. 
