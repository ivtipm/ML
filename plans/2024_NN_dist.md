...
1. Используйте предварительно обученный кодировщик трансформера (нейросеть на основе BERT) для создания векторного представления текста, далее классифицируйте векторные представления текстов.
...
Можно предлагать свои датасеты, они не должны уступать по объёму и сложности датасету из задания.

**Вопросы**
1. Что такое задача классификации?
1. Чем подход кодирования текста с помщью TF-IDF отличается от приницпа обработки текста рекуррентной нейросетью или нейросетью на освнове архитектуры BERT?
1. Как представлены данные? Как они изменяются перед подачей в нейросеть?
1. Опишите архитектуру нейросети, назначение и гиперпараметры каждого слоя.
1. Что такое рекуррентный нейрон? Как он работает?
    - Почему такие нейроны подходят для обработки текста?
    - Опишите достоинства и недостатки.
    - Какие гиперпараметры есть у такого нейрона?
    - Объясните принцип работы LSTM нейрона. Чем он лучше простого рекуррентного нейрона? Какие гиперпараметры есть у такого нейрона?
    - Объясните принцип работы GRU нейрона. Чем он лучше простого рекуррентного и LSTM нейрона? Какие гиперпараметры есть у такого нейрона?
1. Почему выбрали именно такую архитектуру нейросети?
1. Что такое функция потерь? Какую вы использовали и почему? Чем отличается функция потерь от показателя качества (например Accuracy)?
1. Объясните общий принцип работы нейросети на основе архитектуры BERT.
    - Что подаётся на вход? Как разбивается и кодируется текст?
    - Что получается на выходе нейросети? Как это можно использовать в задаче классификации?
    - Какая особенность внутреннего устройства позволяет нейросети достаточно точно "понимать" смысл текста, улавливая связи между словами?
1. Как вы измеряли качество работы нейросети? Что такое переобучение? Как его определить?
1. Сравните расмотренные подходы к классификации текстов. Какие у них приемущества и недостатки?
