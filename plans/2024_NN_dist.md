...
1. Решите задачу классификации текстов. 
...
1. Используйте кодировщик трансформера (нейросеть на основе BERT) для создания вектоного представления текста, далее классифицируйте векторные представления текстов.
...
- Собеседование по темам двух выполненых работ.

Хорошо или Отлично
- Выполнены три работы
- Собеседование по темам трёх выполненых работ.
