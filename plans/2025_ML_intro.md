...
2. Жизненный цикл ML-проекта: этапы от бизнес-задачи до развертывания; обзор методологий (например, CRISP-DM).  [слайды - 1](https://docs.google.com/presentation/d/11zFsnGJAaCzFGGVAjrd_OyNGD-fB6uLr3R-azaof0Qk)
...
5. Первая модель: от идеи к коду: интуитивное понимание линейной и логистической регрессии, использование готовых библиотек (scikit-learn), понятия fit (обучить) и predict (предсказать).
