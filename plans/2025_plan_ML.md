...
Будут рассмотрены классические модели машинного обучения, начиная от регрессий, заканчивая градиентным бустингом и случайным лесом (самые мощные модели, конкурирующие с нейросетями); задачи кластеризации; методы обучения и оптимизации качества этих моделей. В конце курса будут рассмотренные полносвязные нейросети (многослойные персепторн).
...
Например: задача предсказания оттока клиентов банка (задача классификаии), задача разделения покупателей мола по группам (кластеризация), задачи регрессии.
...
**См. также** план предыдущего курса, ссылки и примеры на главной странице, записи лекций предыдущего курса в плейлисте на Ютубе и ТГ канале.
...
### Задание 1. Основы Google colab. Синтетические данные. Простое исследование данных (EDA). Линейная регрессия.
...
# Лекция 2.  Введение в машинное обучение. Pandas. Синтетические данные. Линейная регрессия.
12 февраля
1. Введение: [docs.google.com/presentation/d/1mK9CfhwjQtAdJZENV3vU4nCGSkzI8_Ugkv_AavBVEaM/edit?usp=sharing](https://docs.google.com/presentation/d/1mK9CfhwjQtAdJZENV3vU4nCGSkzI8_Ugkv_AavBVEaM/edit?usp=sharing)
...
# Лекция 3. Показатели качества предсказания. Линейная регрессия. EVA
19 февраля
0. Повторение. Показатели качества регрессии и классификации. 
