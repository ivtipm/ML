...
# Лекция. Отслеживание экпериментов. W&B. MLFlow
15 мая\
...
#### Домашнее задание 11. Многослойный персептрон. 
...
1. Задачи
    ...
    - [ ] 📃 Решена задача классикации текстов
1. 👨🏼‍🏫 Хотябы один раз использованы модели:
    - [ ] Линейная регрессия
