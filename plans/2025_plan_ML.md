...
~Не используйте никакие методы numpy array кроме sum и abs.~
Не используйте циклы, генераторы, функции стандартной библиотеки Питона sum, zip и map, используйте векторные вычисления numpy.
