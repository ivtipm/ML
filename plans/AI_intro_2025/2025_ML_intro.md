...
1. Создайте пайплайн (sklearn pipeline) для обработки данных. Добавьте в него модель. Сохраните пайплайн. Постройте веб-сервис на gradio и API сервер на основе полученного пайплайна. См. аналогичное задание по Языкам программирования для МО.
