...
## Использование LLM
### См. задание RAG по предмету Современная логика и представление знаний
...
# Экзамен
* Консультация — 12 января, 19:00 - 19:30, онлайн
* Экзамен — 13 января, 16:00\
  ауд. 400
...
Загрузите данные для своего варианта: https://github.com/ivtipm/ML/tree/main/plans/ml_exam_data 

Вариант = Ваш номер в таблице % 10, 
% – взятие остатка от деления

Есть ли в данных выбросы? Как признаки влияют на целевой признак?
Приведите другие действия, которые как правило совершаются для анализа и подготовки данных, но сами действия не выполняйте. Используйте заголовки в jupyter notebook.

Решите задачу классификации или регрессии. 
Используйте для классификации логистическую регрессию, для регрессии - линейную регрессию.
Оцените качество модели.

Будьте готовы модифицировать и дополнить код во время ответа по билету.
