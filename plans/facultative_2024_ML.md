...
Используйте векторные представления текстов, полученные из нейросети типа transformer. Пример:

Далее используйте полученные признаки чтобы решить задачу классификации любым из известных Вам методов классификации. 


Бонус: с помощью библиотеки gradio реализуйте пользовательский интерфейс для классификации текстов, которые задаёт пользователь. 