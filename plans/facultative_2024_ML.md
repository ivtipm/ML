...
Выполните либо эту работу, либо предыдущую, по распознованию изображений.
...
Дан набор текстов. Из набора текстов выбрано (прочитано пользователем) несколько текстов. Найти k текстов, похожих на выбранные.\
    Датасет: произвольный набор постов, новостоей, текстов.
6. Рекомендательная система для изображений. Аналогично текстам, но для изображений.
7. Рекомендательная система для изображений, на основе текстов. Аналогично текстам, но рекомендовать изобрадения для текста или части текста изображения из базы данных.
...
Датасет: произвольная база вопросов и ответов. Можно распарсить с сайтов. 
...
7. Подготовить пояснительную записку к работе. Полготовить слайды для защиты.
