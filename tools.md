...
C 2024 года существуют специальные версии Pytorch для некоторых встроенных GPU, например в процессоры intel. Ссылку для скачивания нужно искать в документации.

После установки всех необходимых драйверов и компонентов можно проверить доступность GPU в pytorch
```py
import torch
