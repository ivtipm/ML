...
- **Сохранение состояния.**
  Например только коэффициенты уранвения линейой регрессии или только веса (параметры) нейросети.\
  Файл не привязан к конкретному языку программирования, члабо привязан или не привязан к версии библиотеки.
- **Сохранение состояния и кода**.
  Обычно сохраняется объект модели МО, например переменная типа LinearRegression из sklearn.\
  Сохранение обычно происходит в бинараный файл.\
...
- **Текстовый файл**. Даные в произвольном формате, JSON и др. текстовые форматы.
- **Бинарный файл**.
